...
import com.todays.learning.utils.SettingsUiState
...
class SettingsViewModel(private val settingsRepository: SettingsRepository) :
    ...
    private fun getThemePreference() = viewModelScope.launch(coroutineExceptionHandler) {
    ...
    private fun getImageQualityPreference() = viewModelScope.launch(coroutineExceptionHandler) {
